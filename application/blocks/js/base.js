( function( blocks, components, i18n, element ) {
	...
	blocks.registerBlockType(
		...
		'tkt-gutenberg-blocks/base', {

		// The title of our block.
		title: i18n.__( 'TukuToi Base Block' ),

		// The description of our block.
		description: i18n.__('A Base Block To Build Upon'),
		...
		attributes: {
			name: {
				type: 'array',
				source: 'children',
				selector: 'p.ffxf-testimonial-name',
			},
			position: {
				type: 'array',
				source: 'children',
				selector: 'p.ffxf-testimonial-position',
			},
			testimonial: {
				type: 'array',
				source: 'children',
		...
		edit: function( props ) {
			...
			return [
				...
				el( 'div', { className: props.className },
					el( 'div', {
						className: attributes.mediaID ? 'ffxf-testimonial-image image-active' : 'ffxf-testimonial-image image-inactive',
					...
					el( 'div', {
						className: 'ffxf-testimonial-content', style: { textAlign: alignment } },
						el( RichText, {
							tagName: 'p',
							inline: true,
						...
						el( RichText, {
							tagName: 'p',
							className: 'ffxf-testimonial-name',
							inline: false,
						...
						el( RichText, {
							tagName: 'p',
							className: 'ffxf-testimonial-position',
							inline: false,
		...
		save: function( props ) {
			...
			return (
				el( 'div', { className: props.className },
					attributes.mediaURL &&
					el( 'div', { className: 'ffxf-testimonial-image', style: { backgroundImage: 'url('+attributes.mediaURL+')' } },
						el( 'img', { src: attributes.mediaURL } ),
					),
					el( 'div', { className: 'ffxf-testimonial-content', style: { textAlign: attributes.alignment } },
						attributes.testimonial && el( 'p', {}, attributes.testimonial ),
						el( 'p', { className: 'ffxf-testimonial-name' }, attributes.name ),
						attributes.position && el( 'p', { className: 'ffxf-testimonial-position' }, attributes.position )
					)
				)
			);
		},
